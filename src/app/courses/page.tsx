...
function page() {
  ...
  return (
    <div className="min-h-screen bg-black py-12 pt-34">
      <h1 className="text-lg md:text-5xl text-center font-sans font-bold mb-0 text-white">All Courses ({courseData.courses.length}) </h1>
